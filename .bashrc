...
export FZF_DEFAULT_OPTS="-i --keep-right --filepath-word --height=70% --layout=reverse --info=right --border=sharp --no-scrollbar --marker='+' --header-first --color='dark,fg:white,fg+:cyan,bg+:-1,hl:red,hl+:red,info:black,separator:black,border:black,label:black,prompt:yellow,pointer:cyan,marker:cyan,spinner:black'"
